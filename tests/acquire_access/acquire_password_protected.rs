// acquire when different owner has whitelisted

// acquire when different owner has blacklisted

// acquire when self owns with whitelist

// acquire when self owns with blacklist


use aion_state::prelude::{RegistryAcquireAccess, RegistryAllow, RegistryOwn, RegistryRegister, RegistryReplacement, SynchronisedRegistryAcquireAccessError};
